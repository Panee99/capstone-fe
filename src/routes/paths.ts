...
export const PATH_DASHBOARD = {
  ...
  appUser: {
    ...
    list: path(ROOTS_DASHBOARD, '/app-user/list'),
  },
  warehouse: {
  ...
  beginningVoucher: {
    ...
    new: path(ROOTS_DASHBOARD, '/beginning-voucher/new'),
  ...
  deliveryRequest: {
    root: path(ROOTS_DASHBOARD, '/delivery-request'),
    list: path(ROOTS_DASHBOARD, '/delivery-request/list'),
