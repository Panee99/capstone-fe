...
const vn = {
  ...
  user: `người dùng`,
  dashboard: `thống kê`,
  usergroup: `nhóm nhười dùng`,
  warehouse: `kho`,
  customer: `khách hàng`,
  category: `loại sản phẩm`,
  beginning_voucher: `phiếu tồn kho đầu kì`,
  receive_voucher_request: `phiếu nhập kho`,
  delivery_request: `phiếu yêu cầu xuất kho`,
  delivery_voucher: `phiếu xuất kho`,
  Voucher: `Phiếu`,
  list: `danh sách`,
  edit: `chỉnh sửa`,
  shop: `cửa hàng`,
